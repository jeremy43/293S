...
dataroot = '/home/yq/office_31'
from data.single_dataset import SingleDataset

dataset_path = 'office_local_data.pkl'
test_path = 'office_test_data.pkl'
size = 256
...
def load_office():
    ...
    for name in ['amazon', 'dslr']:
        ...
        print('length of data in domain', len(dataset.data_labels))
...
def prepare_server(da=False):
    ...
    """
    ratio = 0.70#take 10% as the global data
    if da == True:
        ratio = 0.3
    global_data = []
    global_label = []
