...
from dataset.try_domain_dataset import Custom_Dataset, Server_Dataset
from utils.sampling import mnist_iid, mnist_noniid, cifar_iid
#from utils.options import args_parser
from utils.domain_options import args_parser
...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        transform_digit = transforms.Compose([transforms.Resize([256, 384]), transforms.ToTensor(), transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),])
    ...
    elif args.model =='cnn' and args.dataset == 'domain':
