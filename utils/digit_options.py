...
def args_parser():
    ...
    parser.add_argument('--da', action = 'store_false', help="use domain adaptation in training")
    parser.add_argument('--epochs', type=int, default=80, help="rounds of training")
    parser.add_argument('--num_users', type=int, default=150, help="number of users: K")
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='digit', help="name of dataset")
